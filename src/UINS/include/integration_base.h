...
class IntegrationBase
{
  public:
...

    {
        ...
        noise.block<3, 3>(6, 6) =  (0.1 * 0.1) * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(9, 9) =  (0.01 * 0.01) * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(12, 12) =  (0.001 * 0.001) * Eigen::Matrix3d::Identity();
        noise.block<3, 3>(15, 15) =  (0.0001 * 0.0001) * Eigen::Matrix3d::Identity();
    }
